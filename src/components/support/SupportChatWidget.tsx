  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-24 md:bottom-6 right-6 p-4 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 z-[999] ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 md:bottom-6 right-6 left-6 md:left-auto w-auto md:w-96 bg-white rounded-3xl shadow-2xl border border-slate-100 flex flex-col z-[999] overflow-hidden"
