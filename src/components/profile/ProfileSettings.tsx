            ...
            <div className="space-y-6 animate-in fade-in" id="server-settings-tab">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-150 space-y-4">
                ...
                <p className="text-xs text-slate-600 font-medium leading-relaxed">
                  Par défaut, l'application mobile (APK) et le navigateur communiquent avec le serveur de production sécurisé de ResiFaso (<code className="bg-slate-200/80 px-1.5 py-0.5 rounded text-red-650 font-mono text-[11px]">https://www.resifaso.net</code>). 
