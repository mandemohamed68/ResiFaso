            ...
            <div className="space-y-6 animate-in fade-in" id="server-settings-tab">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-150 space-y-4">
                ...
                <p className="text-xs text-slate-600 font-medium leading-relaxed">
                  Par défaut, l'application mobile (APK) et le navigateur communiquent avec le serveur de production sécurisé de ResiFaso (<code className="bg-slate-200/80 px-1.5 py-0.5 rounded text-red-650 font-mono text-[11px]">https://resifaso.net</code>). 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input 
                      ...
                      placeholder="Ex: https://resifaso.net"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                  ...
                  <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-2">
                    ...
                    <span className="font-bold text-slate-800 font-mono text-[11px] block truncate">
                      {localStorage.getItem('custom_server_url') || 'https://resifaso.net'}
                    </span>
                  </div>
                </div>
              </div>
